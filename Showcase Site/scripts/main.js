...
function showPopup(imageId) {
    ...
    const closeButton = document.getElementById("popup_CloseButton");
    const popupImage = document.getElementById("popup_Image");
    const theImage = document.getElementById(imageId);
    const imgClasses = theImage.classList;
    ...
    if (imgClasses.contains('Vert_Rect')) {
        closeButton.style.translate('0px, -400px');
    }
    if (imgClasses.contains('Horiz_Rect')) {
        closeButton.style.translate('0px, -500px');
    }
    if (imgClasses.contains('Horiz_Rect')) { 
    }    
}
